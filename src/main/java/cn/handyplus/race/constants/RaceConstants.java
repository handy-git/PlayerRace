...
public abstract class RaceConstants {
     ...
     * 玩家种族缓存
     */
    public final static Map<String, RacePlayer> PLAYER_RACE = new HashMap<>();

    /**
     * 吸血鬼主动技能吸血缓存
     */
    public static final Map<UUID, Player> VICTIM_ENTITY = new HashMap<>();
     ...
     * 恶魔猎手的弓类型
     */
    public static final Map<UUID, DemonHunterBowTypeEnum> DEMON_HUNTER_BOW = new HashMap<>();
